...
urlpatterns = [
    ...
    path("cars/<int:pk>/toggle-assign/", views.toggle_assign_to_car, name="toggle-car-assign"),
    ...
    path("drivers/<int:pk>/update/", views.DriverLicenseUpdateView.as_view(), name="driver-update"),
